...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/ad/">轮播广告列表</a></li>
		<li class="active"><a href="${ctx}/cms/ad/form?id=${ad.id}">轮播广告设置<shiro:hasPermission name="cms:ad:edit">${not empty ad.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:ad:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
